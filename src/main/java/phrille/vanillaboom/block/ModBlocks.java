...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> OAK_WOOD_FENCE_GATE = BLOCKS.register("oak_wood_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.copy(Blocks.OAK_FENCE)));
    public static final RegistryObject<Block> SPRUCE_WOOD_FENCE_GATE = BLOCKS.register("spruce_wood_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.copy(Blocks.SPRUCE_FENCE)));
    public static final RegistryObject<Block> BIRCH_WOOD_FENCE_GATE = BLOCKS.register("birch_wood_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.copy(Blocks.BIRCH_FENCE)));
    public static final RegistryObject<Block> JUNGLE_WOOD_FENCE_GATE = BLOCKS.register("jungle_wood_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.copy(Blocks.JUNGLE_FENCE)));
    public static final RegistryObject<Block> ACACIA_WOOD_FENCE_GATE = BLOCKS.register("acacia_wood_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.copy(Blocks.ACACIA_FENCE)));
    public static final RegistryObject<Block> DARK_OAK_WOOD_FENCE_GATE = BLOCKS.register("dark_oak_wood_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.copy(Blocks.DARK_OAK_FENCE)));
    public static final RegistryObject<Block> CRIMSON_HYPHAE_FENCE_GATE = BLOCKS.register("crimson_hyphae_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.copy(Blocks.CRIMSON_FENCE).sound(SoundType.STEM)));
    public static final RegistryObject<Block> WARPED_HYPHAE_FENCE_GATE = BLOCKS.register("warped_hyphae_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.copy(Blocks.WARPED_FENCE).sound(SoundType.STEM)));
    public static final RegistryObject<Block> STRIPPED_OAK_WOOD_FENCE_GATE = BLOCKS.register("stripped_oak_wood_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.copy(Blocks.OAK_FENCE)));
    public static final RegistryObject<Block> STRIPPED_SPRUCE_WOOD_FENCE_GATE = BLOCKS.register("stripped_spruce_wood_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.copy(Blocks.SPRUCE_FENCE)));
    public static final RegistryObject<Block> STRIPPED_BIRCH_WOOD_FENCE_GATE = BLOCKS.register("stripped_birch_wood_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.copy(Blocks.BIRCH_FENCE)));
    public static final RegistryObject<Block> STRIPPED_JUNGLE_WOOD_FENCE_GATE = BLOCKS.register("stripped_jungle_wood_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.copy(Blocks.JUNGLE_FENCE)));
    public static final RegistryObject<Block> STRIPPED_ACACIA_WOOD_FENCE_GATE = BLOCKS.register("stripped_acacia_wood_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.copy(Blocks.ACACIA_FENCE)));
    public static final RegistryObject<Block> STRIPPED_DARK_OAK_WOOD_FENCE_GATE = BLOCKS.register("stripped_dark_oak_wood_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.copy(Blocks.DARK_OAK_FENCE)));
    public static final RegistryObject<Block> STRIPPED_CRIMSON_HYPHAE_FENCE_GATE = BLOCKS.register("stripped_crimson_hyphae_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.copy(Blocks.CRIMSON_FENCE).sound(SoundType.STEM)));
